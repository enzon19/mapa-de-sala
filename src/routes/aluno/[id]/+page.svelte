    ...
    <div class="bg-neutral-800 rounded-xl p-4">
      ...
      <div class="my-2 md:mx-auto bg-neutral-850 p-1.5 rounded-2xl">
        ...
        {#if dataManipulation.positionStreak === 'filter'}
          <FilterController minDate="5-2-2024" maxDate="14-11-2024" filter={{day: ['2024-02-05', '2024-11-14'].map(date => DateTime.fromISO(date)),tags: []}} on:filterChanged={event => filterData('positionStreak', event.detail.filter)}/>
        {/if}
      </div>
    ...
    <div class="bg-neutral-800 rounded-xl p-4">
      ...
      <div class="my-2 md:mx-auto bg-neutral-850 p-1.5 rounded-2xl">
        ...
        {#if dataManipulation.timeline === 'filter'}
          <FilterController minDate="5-2-2024" maxDate="14-11-2024" filter={{day: ['2024-02-05', '2024-11-14'].map(date => DateTime.fromISO(date)),tags: []}} on:filterChanged={event => filterData('timeline', event.detail.filter)}/>
    ...
    <div class="bg-neutral-800 rounded-xl p-4">
      ...
      <div class="my-2 md:mx-auto bg-neutral-850 p-1.5 rounded-2xl">
        ...
        {#if dataManipulation.positionRanking === 'filter'}
          <FilterController minDate="5-2-2024" maxDate="14-11-2024" filter={{day: ['2024-02-05', '2024-11-14'].map(date => DateTime.fromISO(date)),tags: []}} on:filterChanged={event => filterData('positionRanking', event.detail.filter)}/>
    ...
    <div class="bg-neutral-800 rounded-xl p-4">
      ...
      <div class="my-2 md:mx-auto bg-neutral-850 p-1.5 rounded-2xl">
        ...
        {#if dataManipulation.absencesPerDay === 'filter'}
          <FilterController minDate="5-2-2024" maxDate="14-11-2024" filter={{day: ['2024-02-05', '2024-11-14'].map(date => DateTime.fromISO(date)),tags: []}} on:filterChanged={event => filterData('absencesPerDay', event.detail.filter)}/>
    ...
    <div class="bg-neutral-800 rounded-xl p-4">
      ...
      <div class="my-2 md:mx-auto bg-neutral-850 p-1.5 rounded-2xl">
        ...
        {#if dataManipulation.absencesPerSubject === 'filter'}
          <FilterController minDate="5-2-2024" maxDate="14-11-2024" filter={{day: ['2024-02-05', '2024-11-14'].map(date => DateTime.fromISO(date)),tags: []}} on:filterChanged={event => filterData('absencesPerSubject', event.detail.filter)}/>
