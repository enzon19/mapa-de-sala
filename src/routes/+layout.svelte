...
<header class="bg-darker-grey p-4 text-center flex flex-col items-center gap-4">
  <div>
    ...
    <p class="text-sm"><a class="hover:text-neutral-400 transition-colors" href="/novidades">v1.2.0</a> • Feito por <a class="hover:text-neutral-400 transition-colors" href="https://enzon19.com">enzon19</a></p>
  </div>
