import { c as create_ssr_component, a as subscribe, e as escape, b as each, d as add_attribute, v as validate_component, m as missing_component, f as compute_rest_props, g as spread, h as escape_object, i as escape_attribute_value } from './index2-fa3938dc.js';
import { p as page } from './stores-4d0fcef3.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="bg-darker-grey p-4 text-center flex flex-col items-center gap-4"><div><a href="/"><h1 class="text-2xl font-bold">Mapa de Sala</h1></a>
    <p class="text-sm"><a class="hover:text-neutral-400 transition-colors" href="/novidades">v1.0.0</a> • Feito por <a class="hover:text-neutral-400 transition-colors" href="https://enzon19.com">enzon19</a></p></div>
...
<footer class="bg-darker-grey text-center text-sm p-4 mt-4"><span><a href="/sobre" class="underline hover:text-neutral-400 transition-colors">Sobre o projeto</a>
    e
...
//# sourceMappingURL=_layout.svelte-67265379.js.map
