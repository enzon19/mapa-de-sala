...
function getAttendancesAndAbsencesFixedAndWithStudentData(allClassroomMapData, student, includeAllData = false) {
  ...
  if (includeAllData)
    return { student, attendances, absences };
...
function generateAbsencesPerDay(allClassroomMapData, student) {
...
function generateAbsencesPerDayHumanReadable(allClassroomMapData, student, sort) {
...
function generateDatasetsOfAbsencesPerDay(allClassroomMapData, studentsData) {
  let dataset = {
...
function getDayURL(day, studentID) {
  const dayAsDateTime = DateTime.fromISO(day);
...
export { generateRankedGroupedPositionHumanReadable as a, generateAbsencesPerDayHumanReadable as b, countAttendancesAndAbsences as c, generatePositionTimeline as d, getDayURL as e, generateFrequencyOfPosition as f, getAttendancesAndAbsences as g, generateDatasetsOfStudentsAttendanceAndChairs as h, generateDatasetsOfSpacesAndEmptyChairs as i, generateDatasetsOfAbsencesPerDay as j, getAttendancesAndAbsencesFixedAndWithStudentData as k, countStudentsAttendance as l, countChairs as m, countSpaces as n, countEmptyChairs as o };
//# sourceMappingURL=getStats-26dc7d04.js.map
