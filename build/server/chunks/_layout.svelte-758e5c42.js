...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="bg-darker-grey p-4 text-center flex flex-col items-center gap-4"><div><a href="/"><h1 class="text-2xl font-bold">Mapa de Sala</h1></a>
    <p class="text-sm"><a class="hover:text-light-grey transition-colors" href="/novidades">v0.4.0</a> • Feito por enzon19</p></div>
  ...
  <nav class="grid grid-flow-col grid-cols-3 gap-3 text-center">${each(pages, (page2) => {
    return `<a class="${[
      "flex flex-row gap-2 justify-center items-center p-2 rounded-xl cursor-pointer transition-colors bg-neutral-800 hover:bg-neutral-700 active:bg-neutral-600",
      currentURL.match(page2.pattern) ? "bg-neutral-600" : ""
...
//# sourceMappingURL=_layout.svelte-758e5c42.js.map
