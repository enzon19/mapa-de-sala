...
const index = 4;
const component = async () => (await import('./_page.svelte-0db683ba.js')).default;
const server_id = "src/routes/dados/+page.server.js";
const imports = ["_app/immutable/nodes/4.1f255497.js","_app/immutable/chunks/index.c02989e7.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets };
//# sourceMappingURL=4-671c69fd.js.map
