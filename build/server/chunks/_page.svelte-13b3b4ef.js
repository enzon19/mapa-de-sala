...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-qwd9sp_START -->${$$result.title = `<title>${escape(data.student.name)} no Mapa de Sala</title>`, ""}<meta name="description"${add_attribute("content", `Veja dados interessantes sobre ${data.student.name}! Tem a primeira e última aparição, presenças, faltas, mapa de calor e outras bobagens.`, 0)}><!-- HEAD_svelte-qwd9sp_END -->`, ""}
...
//# sourceMappingURL=_page.svelte-13b3b4ef.js.map
