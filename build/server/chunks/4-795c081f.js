...
const index = 4;
const component = async () => (await import('./_page.svelte-51aaf6bb.js')).default;
const file = '_app/immutable/entry/editar-_day_day_-_month_month_-page.svelte.84f2fe4a.js';
const server_id = "src/routes/editar/[day=day]-[month=month]/+page.server.js";
const imports = ["_app/immutable/entry/editar-_day_day_-_month_month_-page.svelte.84f2fe4a.js","_app/immutable/chunks/index.23c5746a.js","_app/immutable/chunks/datetime.ecc857da.js","_app/immutable/chunks/DateInput.fbc65c3d.js"];
const stylesheets = [];
const fonts = [];

export { component, file, fonts, imports, index, _page_server as server, server_id, stylesheets };
//# sourceMappingURL=4-795c081f.js.map
