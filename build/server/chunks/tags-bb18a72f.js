...
import { d as countStudentsAttendance, e as countChairs, f as countSpaces, h as countEmptyChairs } from './getStats-d0566680.js';
...
const DateInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex items-center gap-2 m-4 justify-center"><a class="inline-block cursor-pointer"${add_attribute("href", `/${route}/` + yesterday.toFormat("dd-MM"), 0)}>${validate_component(ChevronBack, "ChevronBack").$$render(
    $$result,
    {
      size: "2rem",
  ...
  <a class="inline-block cursor-pointer"${add_attribute("href", `/${route}/` + tomorrow.toFormat("dd-MM"), 0)}>${validate_component(ChevronForward, "ChevronForward").$$render(
    $$result,
    {
      size: "2rem",
      class: "focus:outline-none focus:text-neutral-400"
...
//# sourceMappingURL=tags-bb18a72f.js.map
